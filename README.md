...
local venyx = library.new("Shindo Alliance | erndnz00#7726| Discord Kategorisine Bak", 5013109572)
...
--Three page
local page3 = venyx:addPage("Gorev Yap", 5012544693)
local d = page3:addSection("Gorev Yap")

    d:addButton("KOS",function()
		for i = 1,300 do
    ...
    d:addButton("CHAKRA SARJ",function()
		for i = 1,500 do
    ...
    d:addButton("VURUS TAHTASINA GIT",function()
        local player = game.Players.LocalPlayer
...
local spin = inf:addSection("Sonsuz Spin")
	...
	local a1
	spin:addDropdown("KG Sec",kgs,function(KG1)
		print("Selected: " .. KG1)
		a1 = KG1
	end)
	local a2
	spin:addDropdown("KG Sec",kgs,function(KG2)
		print("Selected: " .. KG2)
		a2 = KG2
	end)
	local a3
	spin:addDropdown("KG Sec",kgs,function(KG3)
		print("Selected: " .. KG3)
		a3 = KG3
	end)
	local a4
	spin:addDropdown("KG Sec",kgs,function(KG4)
		print("Selected: " .. KG4)
		a4 = KG4
	end)
	local a5
	spin:addDropdown("KG Sec",kgs,function(KG5)
		print("Selected: " .. KG5)
		a5 = KG5
	end)
	spin:addButton("Basla Spin KG",function()
	...
	spin:addButton("Spin Resetle Simdi",function()
        player.statz.spins:Destroy()
        game:GetService('TeleportService'):Teleport(game.PlaceId, player)	 
    end)
end
...
local Discord = page5:addSection("Alliance Shindo Life")

Discord:addButton("Copy Discord Link", function()
    setclipboard("https://discord.gg/7n4pqPbK")
end)
    
local Discord = page5:addSection("Edit")

Discord:addButton("Alliance Army Kurucusu erndnz00#7726", function()
end)

-- Theme page
local settings = venyx:addPage("Ayarlar", 5012544693)
local colors = settings:addSection("Renkler")
local setting = settings:addSection("Ayarlar")

setting:addKeybind("Goster/Gizle Ayar", Enum.KeyCode.P, function()
